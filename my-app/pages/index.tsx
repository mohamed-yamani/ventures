...
const inter = Pacifico({ weight: "400" });
  ...
  return (
    ...
    >
      <div className="z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
        ...
        <div className="justify-centerff fixed bottom-0 left-0 flex h-48 w-full items-end dark:from-black dark:via-black lg:static lg:h-auto lg:w-auto lg:bg-none">
          <a
